...
namespace HRMS.Server.Migrations
{
    ...
    [Migration("20240417150642_DB migration-creating snapshot plus mig-files")]
    partial class DBmigrationcreatingsnapshotplusmigfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.Server.Model.Attendance", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Server.Model.Department", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Server.Model.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRMS.Server.Model.Leave", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Server.Model.Payroll", b =>
                {
                    b.Property<int>("PayrollId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRMS.Server.Model.Project", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRMS.Server.Model.Recruitment", b =>
                {
                    ...
                    b.ToTable("reccruitments");
                });

            modelBuilder.Entity("HRMS.Server.Model.Training", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Server.Model.Attendance", b =>
                {
                    b.HasOne("HRMS.Server.Model.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.Server.Model.Employee", b =>
                {
                    b.HasOne("HRMS.Server.Model.Department", "department")
                        .WithMany()
                        .HasForeignKey("DepartmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMS.Server.Model.Payroll", "payroll")
                        .WithMany()
                        .HasForeignKey("PayrollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMS.Server.Model.Project", "project")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.Server.Model.Training", b =>
                {
                    b.HasOne("HRMS.Server.Model.Employee", "employeeTrainee")
                        .WithMany()
                        .HasForeignKey("TraineeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMS.Server.Model.Employee", "employeeTrainer")
                        .WithMany()
